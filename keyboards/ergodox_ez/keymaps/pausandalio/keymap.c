...
#define BASE_LINUX  1 // Base layer for Linux
#define SYMB        2 // symbols & numbers
#define MOUSE       3 // mouse keys
#define FUNCT       4 // fn keys
...
/* Keymap 0: Base layer for MaxOS
 *
 * ,---------------------------------------------------------.          ,---------------------------------------------------------.
 * |    `    |   1   |   2   |   3   |   4   |   5   | VolDn |          | VolUp |   6   |   7   |   8   |   9   |   0   |   <=    |
 * |---------+-------+-------+-------+-------+-------+-------|          |-------+-------+-------+-------+-------+-------+---------|
 * |  Del    |   Q   |   W   |   E   |   R   |   T   |  MEH  |          | HYPER |   Y   |   U   |   I   |   O   |   P   |    +    |
 * |---------+-------+-------+-------+-------+-------|       |          |       |-------+-------+-------+-------+-------+---------|
 ...
 *                                           | Left  | Right |          | Down  |  Up   |
 *                                   ,-------|-------|-------|          |-------+-------+-------.
 *                                   |  Tab  |  Esc  | Mute  |          |SysReq | Enter | Space |
 *                                   |   /   |   /   |-------|          |-------|   /   |   /   |
 *                                   | Shift |  Cmd  | Caps  |          | Caps  |  Cmd  | Shift |
 *                                   `-----------------------'          `-----------------------'
 */
  [BASE_MACOS] = LAYOUT_ergodox(
      // LEFT HAND ---------------------------------------------------------------------------------
      ...
      KC_HOME,          KC_PGUP, TG(4), TG(3), TG(2),
                                               ...
                                               LSFT_T(KC_TAB), LCMD_T(KC_ESC), KC_CAPS,
                                                                                                 ...
                                                                                                 // RIGHT HAND ---------------------------------------------------------------------------------------------------------------
                                                                                                                      ...
                                                                                                                      KC_HYPR,         KC_Y,       KC_U,         KC_I,        KC_O,                KC_P,      KC_PLUS,
                                                                                                                                       LT(3,KC_H), LT(2,KC_J),   KC_K,        KC_L,                KC_COLN,   CTL_T(KC_EQUAL),
                                                                                                                      KC_HYPR,         KC_N,       LCA_T(KC_M),  KC_COMMA,    KC_DOT,              KC_SLASH,  KC_RALT,
                                                                                                                                                   KC_LBRACKET,  KC_RBRACKET, KC_MEDIA_PLAY_PAUSE, KC_PGDOWN, KC_END,
                                                                                                  KC_DOWN,    KC_UP,
                                                                                                  KC_PSCREEN,
                                                                                                  KC_CAPS,    LCMD_T(KC_ENTER), RSFT_T(KC_SPACE)),

/* Keymap 1: Base layer for Linux
 *
 * ,---------------------------------------------------------.          ,---------------------------------------------------------.
 * |    `    |   1   |   2   |   3   |   4   |   5   | VolDn |          | VolUp |   6   |   7   |   8   |   9   |   0   |   <=    |
 * |---------+-------+-------+-------+-------+-------+-------|          |-------+-------+-------+-------+-------+-------+---------|
 ...
 */
  [SYMB] = LAYOUT_ergodox(
      ...
      KC_TRANSPARENT, KC_TRANSPARENT, TG(2),     TG(2),        TG(2),
                                                                      KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                      KC_TRANSPARENT,
                                                      KC_TRANSPARENT, KC_TRANSPARENT, TG(2),

                                                                                                 // RIGHT HAND -------------------------------------------------------------------------------------------------
                                                                                                                      KC_NO, KC_NO, KC_NO,    KC_KP_SLASH, KC_KP_ASTERISK, KC_MINUS, KC_TRANSPARENT,
                                                                                                                      KC_NO, KC_NO, KC_7,     KC_8,        KC_9,           KC_PLUS,  KC_NO,
                                                                                                                             KC_NO, KC_4,     KC_5,        KC_6,           KC_EQUAL, KC_NO,
                                                                                                                      KC_NO, KC_NO, KC_1,     KC_2,        KC_3,           KC_NO,    KC_NO,
                                                                                                                                    KC_COMMA, KC_0,        KC_KP_DOT,      KC_NO,    KC_NO,
                                                                                                  KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                  KC_TRANSPARENT,
                                                                                                  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT),

/* Keymap 3: Mouse control and arrows
 *
 * ,---------------------------------------------------------.          ,---------------------------------------------------------.
 ...
 */
  [MOUSE] = LAYOUT_ergodox(
      ...
      KC_TRANSPARENT, KC_TRANSPARENT, TG(3),          TG(3),          TG(3),
                                                                      KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                      KC_TRANSPARENT,
                                                      KC_TRANSPARENT, KC_TRANSPARENT, TG(3),
                                                                                                 ...
                                                                                                 // RIGHT HAND ----------------------------------------------------------------------------------------------------------------------
                                                                                                                      ...
                                                                                                                      KC_MEDIA_PLAY_PAUSE, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                                                           TG(3),          TG(3),          TG(3),          KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                  KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                  KC_TRANSPARENT,
                                                                                                  KC_TRANSPARENT, KC_MS_BTN2, KC_MS_BTN1),


/* Keymap 4: Function keys and colors
 *
 * ,---------------------------------------------------------.          ,---------------------------------------------------------.
 * |  Blue   | Green |Orange |Purple |  Red  |       |BLinux |          |BMaxOS |       |  F10  |  F11  |  F12  |       |  Power  |
 * |---------+-------+-------+-------+-------+-------+-------|          |-------+-------+-------+-------+-------+-------+---------|
 * |         |       |       | Hue-  | Hue+  |       |       |          |       |       |  F7   |  F8   |  F9   |       |         |
 * |---------+-------+-------+-------+-------+-------|       |          |       |-------+-------+-------+-------+-------+---------|
 ...
 */
  [FUNCT] = LAYOUT_ergodox(
      // LEFT HAND ----------------------------------------------------------------------------------
      HSV_240_255_255, HSV_120_255_128, HSV_38_255_255, HSV_300_255_128, HSV_0_255_255,  KC_TRANSPARENT, DF(1),
      ...
      KC_TRANSPARENT,  KC_TRANSPARENT,  TG(4),          TG(4),           TG(4),
                                                                      KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                      KC_TRANSPARENT,
                                                             RGB_TOG, KC_TRANSPARENT, TG(4),

                                                                                                 // RIGHT HAND ----------------------------------------------------------------------------------------------------------------------
                                                                                                                      DF(0),          KC_TRANSPARENT, KC_F10, KC_F11, KC_F12, KC_TRANSPARENT, KC_SYSTEM_POWER,
                                                                                                                      ...
                                                                                                                      KC_TRANSPARENT, KC_TRANSPARENT, KC_F1,  KC_F2,  KC_F3,  KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                                                      TG(4),  TG(4),  TG(4),  KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                  KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                  KC_TRANSPARENT,
                                                                                                  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT),
};
...
void led_set_user(uint8_t usb_led) {
  if (IS_LED_ON(usb_led, USB_LED_CAPS_LOCK)) {
    ...
    if (biton32(layer_state) == 4) {
      ...
      rgblight_setrgb_at(RGBLIGHT_COLOR_LAYER_4, 13);
      rgblight_setrgb_at(RGBLIGHT_COLOR_LAYER_4, 14);
    }
  }
}
